...
function get_user_detail() {
    ...
    fetch('https://ireporter256version2.herokuapp.com/api/v2/users/'+localStorage.getItem('user_id'),
    {
        headers:{
...
function get_user_stats() {
    ...
    fetch('https://ireporter256version2.herokuapp.com/api/v2/users/'+user_id+'/stats',
    {   
        headers:{
            'Authorization': localStorage.getItem('access_token')
        }
